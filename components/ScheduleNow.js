...
const ScheduleNow = ({ currentShowData, nextShowData }) => {
    ...
    return (
        <>
            <Text style={styles.nowTimeText} adjustsFontSizeToFit >{formatReadableTime(checkedCurrentShowData['starts'])}</Text>
            <Text style={styles.nowTitleText} adjustsFontSizeToFit={true} numberOfLines={5}>{checkedCurrentShowData['name']} </Text>
            {/* <Text style={styles.nowTitleText} adjustsFontSizeToFit numberOfLines={5}>EHFM Night Music for night time people</Text> */}
        </>
